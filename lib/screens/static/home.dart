...
import 'package:itopya_mobile/bloc/client/client_cubit.dart';
import 'package:itopya_mobile/bloc/favorite/products_cubit.dart';
import 'package:itopya_mobile/core/cache.dart';
import 'package:itopya_mobile/favorites/favorites.dart';
import 'package:itopya_mobile/model/home_products_model.dart';
import 'package:itopya_mobile/screens/product/keyboard.dart';
          ...
          children: [
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () {
                  GoRouter.of(context).go('/keyboard');
                },
                child: Column(
                  children: [
                    Row(
                        ...
                        GestureDetector(
                          ...
                          child: Column(
                            children: [
                              ...
                              Gap(3),
                              Text(
                                AppLocalizations.of(context).getTranslate("PC"),
                                style: GoogleFonts.poppins(
                    ...
                    Row(
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            GoRouter.of(context).go('/headset');
                          },
                          child: Column(
                            children: [
                              CircleAvatar(
                        ...
                        GestureDetector(
                          onTap: () {
                            GoRouter.of(context).go('/monitor');
                          },
                          child: Column(
                            children: [
                              CircleAvatar(
          ...
          children: [
            ...
            InkWell(
              ...
              child: Container(
                ...
                child: Center(
                  child: Text(
                    AppLocalizations.of(context).getTranslate("Kasa"),
                    style: GoogleFonts.poppins(
                        fontSize: 10,
                        color: Theme.of(context).brightness == Brightness.dark
                            ? Colors.white
            ...
            InkWell(
              ...
              child: Container(
                ...
                child: Center(
                  child: Text(
                    AppLocalizations.of(context).getTranslate("Klavye"),
                    style: GoogleFonts.poppins(
                        fontSize: 10,
                        color: Theme.of(context).brightness == Brightness.dark
                            ? Colors.white
            ...
            InkWell(
              ...
              child: Container(
                ...
                child: Center(
                  child: Text(
                    AppLocalizations.of(context).getTranslate("Kulaklık"),
                    style: GoogleFonts.poppins(
                        fontSize: 10,
                        color: Theme.of(context).brightness == Brightness.dark
                            ? Colors.white
            ...
            InkWell(
              ...
              child: Container(
                ...
                child: Center(
                  child: Text(
                    AppLocalizations.of(context).getTranslate("Monitör"),
                    style: GoogleFonts.poppins(
                        fontSize: 9,
                        color: Theme.of(context).brightness == Brightness.dark
                            ? Colors.white
