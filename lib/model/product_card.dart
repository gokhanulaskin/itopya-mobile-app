...
import 'package:itopya_mobile/model/product.dart';
...
class ProductCard extends StatefulWidget {
  ...
  ProductCard(
      ...
      required this.onTap,
      required this.functionOnTapFavorite});
                ...
                children: [
                  ...
                  ClipRRect(
                    borderRadius: BorderRadius.circular(
                        10.0), // Kenar yarıçapını belirleyin
                    child: Hero(
                      tag: widget.product
                          .photo, // Ürünün resmi için benzersiz bir etiket
                      child: Image.asset(
